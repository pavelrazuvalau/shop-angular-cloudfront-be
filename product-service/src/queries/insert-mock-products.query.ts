...
export default products.reduce((resultQuery, currentProduct) => resultQuery.concat(`
  insert into products(title, description, price, imageUrl) values ('${currentProduct.title}', '${currentProduct.description}', ${currentProduct.price}, '${currentProduct.imageUrl}');
